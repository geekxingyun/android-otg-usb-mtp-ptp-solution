...
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosEventCheckCommand;
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosGetLiveViewPictureCommand;
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosOpenSessionAction;
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosSetLiveViewAction;
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosSetPropertyCommand;
import com.xingyun.readcameraptpapp.ptp.commands.eos.EosTakePictureCommand;
...
public class EosCamera extends PtpCamera {
    ...
    protected void onOperationCodesReceived(Set<Integer> operations) {
        if (operations.contains(PtpConstants.Operation.EosGetLiveViewPicture)) {
            liveViewSupported = true;
        }
        if (operations.contains(PtpConstants.Operation.EosBulbStart) && operations.contains(PtpConstants.Operation.EosBulbEnd)) {
            bulbSupported = true;
        }
