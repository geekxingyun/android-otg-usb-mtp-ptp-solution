package com.xingyun.smartcontentresolveapp.custom;
...
public class MyUsbDocumentProvider extends DocumentsProvider {

    private static final String TAG = com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.class.getSimpleName();

    private static final String DOCUMENTS_AUTHORITY = "com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider";
    ...
    private final Map<String, com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition> mRoots = new HashMap<>();
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        SmartLogUtils.showError("queryRoots()",true);
        // Create a cursor with either the requested fields, or the default projection if "projection" is null.
        final MatrixCursor result = new MatrixCursor(resolveRootProjection(projection));

        for (Map.Entry<String, com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition> root : mRoots.entrySet()) {
            com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition usbPartition = root.getValue();
            ...
            SmartLogUtils.showError("title"+title,true);
            SmartLogUtils.showError("addRoot"+documentId,true);
            ...
            row.add(DocumentsContract.Root.COLUMN_ICON, com.github.mjdev.libaums.storageprovider.R.drawable.ic_usb_black_24dp);
    ...
    public Cursor queryDocument(String documentId, String[] projection) throws FileNotFoundException {
        SmartLogUtils.showDebug("queryDocument() " + documentId,true);
        try {
    ...
    private void addRoot(UsbMassStorageDevice device) {
        ...
        try {
            ...
            for (Partition partition : device.getPartitions()) {
                com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition usbPartition = new com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition();
    ...
    private UsbFile getFileForDocId(String documentId) throws IOException {
        ...
        if (splitIndex < 0) {
            ...
            com.xingyun.smartcontentresolveapp.custom.MyUsbDocumentProvider.UsbPartition usbPartition = mRoots.get(rootId);
